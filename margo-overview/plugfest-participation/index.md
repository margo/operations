...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="prev" href="../margo-overview/documentation/">

        <link rel="next" href="../margo-overview/governance/">
...
<header class="md-header md-header--shadow" data-md-component="header">
  <nav class="md-header__inner md-grid" aria-label="Header">
    <a href="https://margo.org" title="Operations" class="md-header__button md-logo" aria-label="Operations" data-md-component="logo">
...
<nav class="md-nav md-nav--primary md-nav--integrated" aria-label="Navigation" data-md-level="0">
  <label class="md-nav__title" for="__drawer">
    <a href="https://margo.org" title="Operation" class="md-nav__button md-logo" aria-label="Operations" data-md-component="logo">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="../../member-onboarding" class="md-nav__link">
  <span class="md-ellipsis">
    Member Onboarding
  </span>
      </a>
    ...
    <li class="md-nav__item">
      <a href="../../getting-to-know-margo/" class="md-nav__link">
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="../../margo-overview/membership-benefits/" class="md-nav__link">
  <span class="md-ellipsis">
    Membership Benefits
  </span>
      </a>
    ...
    <li class="md-nav__item">
      <a href="../../collaborating-with-github/" class="md-nav__link">
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="../../margo-overview/documentation/" class="md-nav__link">
  <span class="md-ellipsis">
...
To encourage participation in the PlugFest, we have created these Rules of Engagement. As a requirement to participate in the PlugFest, all Participants (and their employees and independent contractors) must comply with these Rules of Engagement. Participation in the PlugFest means agreement to these Rules of Engagement. 

The PlugFest is not a certification process, and Participants will not be able to say that their hardware is “MARGO Compliant” following the PlugFest. Instead, Participants should expect to receive interoperability data with respect to their products. 
...
Only the final, official report issued by MARGO should be publicly quoted or reproduced. Participants are strongly advised to refrain from sharing anecdotal information that cannot be substantiated by the official report. 

Furthermore, participants hereby acknowledge and agree that, under no circumstances, shall the results derived from the PlugFest be utilized for comparative marketing purposes. 
...
<script>var target=document.getElementById(location.hash.slice(1));target&&target.name&&(target.checked=target.name.startsWith("__tabbed_"))</script>
      ...
      <nav class="md-footer__inner md-grid" aria-label="Footer" >
        ...
        <a href="../.." class="md-footer__link md-footer__link--prev" aria-label="Previous: Introduction">
          ...
          <a href="../../member-onboarding" class="md-footer__link md-footer__link--next" aria-label="Next: Membership Onboarding">
            <div class="md-footer__title">
              <span class="md-footer__direction">
                Next
              </span>
